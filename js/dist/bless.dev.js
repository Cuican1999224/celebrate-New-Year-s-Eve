...
var page1 = {
  ...
  init: function init() {
    ...
    window.addEventListener("resize", resetMarginTop); // 点击下一页的按钮事件
...
var page2 = {
  ...
  render: function render() {
    ...
    // 设置提示文本
    this.doms.desc.innerText = "\u4F60\u53EF\u4EE5\u5F55\u5236".concat(this.sound.maxSeconds, "\u79D2\u7684\u97F3\u9891"); // 设置剩余时间不显示
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            this.sound.remainSeconds = this.sound.maxSeconds; //4.rennder
        ...
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            ...
            return regeneratorRuntime.awrap(utils.audioRecorder.stopAndUpload("https://bless.yuanjin.tech/api/upload", {
              ...
              accessKeyId: "LTAI4G9JHH65MYmcCjvpBQ4K",
              accessKeySecret: "K8n5eLNlekGYH5It5LjfqMhc4vl2bq",
              bucket: "happy-new-year-can"
            }));
